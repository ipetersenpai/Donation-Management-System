<div class="navbar-container">
    ...
    <form id="profile-form" class="open-menu d-flex align-items-center justify-content-center gap-1"
        @if (auth()->user()->role === 'Admin') <p>Hello, Admin!</p> @endif
        @if (auth()->user()->role === 'Personnel') <p>Hello, Personnel!</p> @endif <svg xmlns="http://www.w3.org/2000/svg"
