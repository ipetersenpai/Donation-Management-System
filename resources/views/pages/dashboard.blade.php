...
@section('content')
                    ...
                    <div class="col-md-6">
                        <div class="card card-chart">
                            <div class="card-body relative">
                                <h5 class="card-title" style="font-weight: bold">Summary of Funds</h5>
                    ...
                    <div class="col-md-6">
                        <div class="row flex-wrap">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="card card-layout">
                                    <div class="d-flex flex-column justify-items-center justify-content-center"
                                        style="min-width:40%; background-color: #007bff; color:white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                            fill="currentColor" class="bi bi-people-fill mx-auto" viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="col-12 col-md-6">
                                <div class="card card-layout">
                                    <div class="d-flex flex-column justify-items-center justify-content-center"
                                        style="min-width:40%; background-color: #28a745; color:white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                            fill="currentColor" class="bi bi-currency-exchange mx-auto" viewBox="0 0 16 16">
                                            <path
                            ...
                            <div class="col-12 col-md-6">
                                <div class="card card-layout">
                                    <div class="d-flex flex-column justify-items-center justify-content-center"
                                        style="min-width:40%; background-color: #dc3545; color:white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                            fill="currentColor" class="bi bi-currency-exchange mx-auto" viewBox="0 0 16 16">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="card card-layout">
                                    <div class="d-flex flex-column justify-items-center justify-content-center"
                                        style="min-width:40%; background-color: #17a2b8; color:white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                            fill="currentColor" class="bi bi-currency-exchange mx-auto" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd"
                                                d="M3.5 6a.5.5 0 0 0-.5.5v8a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-8a.5.5 0 0 0-.5-.5h-2a.5.5 0 0 1 0-1h2A1.5 1.5 0 0 1 14 6.5v8a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 14.5v-8A1.5 1.5 0 0 1 3.5 5h2a.5.5 0 0 1 0 1z" />
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-text" id="totalFundAllocation" style="font-weight: 600">Loading...
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="card card-layout">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-text" id="remainingBalance" style="font-weight: 600">Loading...
                                        </h4>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.get('{{ route('remaining_balance.balance') }}', function(data) {
                $('#remainingBalance').text(data.remaining_balance.toLocaleString());

                // Data for the pie chart
                const remainingBalance = data.remaining_balance;
                const totalAllocatedAmount = $('#totalFundAllocation').text().replace(/,/g, '');
                const allocatedAmount = parseFloat(totalAllocatedAmount);

                const chartData = {
                    labels: ['Remaining Balance', 'Allocated Funds'],
                    datasets: [{
                        data: [remainingBalance,
                            allocatedAmount
                        ], // Do not subtract remainingBalance from allocatedAmount
