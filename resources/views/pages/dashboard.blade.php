                    ...
                    <div class="col-md-3">
                        <div class="card card-layout">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-text" style="font-weight: 600">23918</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-layout">
                            ...
                            <div class="card-body">
                                <h5 class="card-title" style="font-weight: bold">Total Donated</h5>
                                <h4 class="card-text" style="font-weight: 600">8918</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card card-layout">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-text" style="font-weight: 600">1389917</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
